...
2. Completa el formulario con la información del proyecto:
   ...
   - Nombre de la autora
   - Puesto de trabajo
3. Sube las imágenes del proyecto y de la autora
4. Observa la vista previa en tiempo real
5. Haz clic en **"Crea tu proyecto"**

### Ver proyectos

- Haz clic en **"Ver Proyectos"** para acceder al listado completo
- Cada tarjeta muestra un resumen del proyecto
- Haz clic en cualquier tarjeta para ver los detalles completos

## Equipo

Proyecto desarrollado por el **Equipo 1 de la Promoción 55 - Módulo 4** de Adalab, formado por:
